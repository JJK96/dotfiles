...
theme.icon_dir                      = os.getenv("HOME") .. "/.config/awesome/themes/jjk-grey/icons"

theme.wallpaper                     = os.getenv("HOME") .. "/Pictures/wallpapers/dna-futuristic-wallpaper.jpg"

theme.topbar_path                   = "png:" .. theme.icon_dir .. "/topbar/"
theme.font                          = "cantarell 10"
theme.taglist_font                  = theme.font;
theme.fg_normal                     = "#80CCE6" 
theme.fg_focus                      = "#FFFFFF"--"#0099CC" 
theme.bg_normal                     = "#242424" 
theme.fg_urgent                     = "#CC9393"
theme.bg_urgent                     = "#2A1F1E"
theme.bg_systray		    = "#00181a" 
